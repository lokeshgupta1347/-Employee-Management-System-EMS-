...
export const createLeaves=async(req,res)=>{
    try {
        ...
        // Validate that leave dates are in the future
        ...
        if (isAdmin) {
            ...
            const data = leaves.map((l) => {
                ...
                return {
                    ...obj,
                    id: obj._id.toString(),
                    employee: obj.employeeId ,// Populated employee details
            ...
            // If the user is an employee, fetch their individual leave applications
...
export const updateLeavesStatus=async(req,res)=>{
    try {
        ...
        // Find the leave record by ID and update its status
