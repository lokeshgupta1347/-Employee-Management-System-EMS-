    ...
    return (
        ...
        {/* Personal Information */}
                    <div className="card p-5 sm:p-6">
                        ...
                        rows={3} className="resize-none" placeholder="Brief 
                        description..." />
                    </div>
                        ...
                        text-slate-700">
                            ...
                            <div>
                             ...
                             <div>
                                ...
                                <input name="basicSalary" required min="0" step="0.01" defaultValue={initialData?.basicSalary || 0} />
                            </div>
                             <div>
                             ...
                             <div>
                                ...
                                <input name="deductions" required min="0" step="0.01" defaultValue={initialData?.deductions || 0} />
                            </div>
                            {isEditMode && (
                                 <div>
