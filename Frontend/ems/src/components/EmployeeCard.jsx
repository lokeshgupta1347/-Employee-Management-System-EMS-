  ...
  return (
    ...
    <div className='relative aspect-4/3 w-full overflow-hidden bg-linear-to-br from-slate-100 to-slate-50'>
        ...
        <div className='absolute top-3 left-3 flex gap-2'>
            <span className='bg-white/50 backdrop-blur-sm px-2.5 py-1 text-xs font-semibold text-slate-600 rounded-lg shadow-sm'>
        ...
        {!employee.isDeleted && (
            ...
            justify-center pb-6 gap-3'>
                ...
                bg-white/90 backdrop-blur-sm text-slate-700 hover:text-rose-600 
