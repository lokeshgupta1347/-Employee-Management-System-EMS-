  ...
  return (
    <div className='max-w-2xl mx-auto p-8 bg-white animate-fade-in'>
      ...
      <div>
          ...
          <p className='font-semibold text-slate-850'>{payslip.employee?.firstName} {payslip.employee?.lastName}</p>
      </div>
      <div>
          <p className='text-xs text-slate-400 uppercase tracking-wider mb-1'>Position</p>
          <p className='font-semibold text-slate-800'>{payslip.employee?.position}</p>
        </div>

        <div>
          <p className='text-xs text-slate-400 uppercase tracking-wider mb-1'>Email</p>
          <p className='font-semibold text-slate-800'>{payslip.employee?.email}</p>
        </div>

        <div>
          <p className='text-xs text-slate-400 uppercase tracking-wider mb-1'>Period</p>
          <p className='font-semibold text-slate-800'>{format(new Date(payslip.year, payslip.month - 1), "MMMM yyyy")}</p>
        </div>
      ...
      <div className='rounded-xl border border-slate-200 overflow-hidden mb-8'>
        <table className='w-full text-sm'>
          ...
          <tbody>
            ...
            <tr className='border-b border-slate-100'>
              <td className='py-3 px-4 text-slate-600'>Allowances</td>
              <td className='text-right py-3 px-4 text-slate-900 font-medium'>
            ...
            <tr className='border-b border-slate-100'>
              <td className='py-3 px-4 text-slate-600'>Deductions</td>
              <td className='text-right py-3 px-4 text-slate-900 font-medium'>
            ...
            <tr className='border-t-2  border-slate-200 bg-slate-50'>
              ...
              <td className='text-right py-4 px-4 text-slate-900 text-lg'>
