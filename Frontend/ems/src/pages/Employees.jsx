...
const Employees = () => {
  ...
  const fetchEmployees=useCallback(async()=>{
    setloading(true)
    setemployees(dummyEmployeeData.filter((emp)=>(selectdepartments ? emp.department===selectdepartments : emp)))
    setTimeout(() => {
      setloading(false)
  ...
  return (
    ...
    <select value={selectdepartments} onChange={(e)=>setselectdepartments(e.target.value)} className="max-w-48">
